...
def get_config():
    ...
    parser.add_argument("--modal_fusion_strategy",type=str,default='F3Mamba')
    ...
    parser.add_argument("--data_path", type=str, default=r"F3Mamba/Dataset/LabDataset", help="Path to the dataset.")
    ...
    parser.add_argument("--train_ids", type=list, default=[1,2,3])
    parser.add_argument("--test_ids", type=list, default=[4,5])
